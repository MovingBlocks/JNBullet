...
public class btAxisSweep3InternalShort extends btBroadphaseInterface {
  ...
  public btAxisSweep3InternalShort(Vector3f worldAabbMin, Vector3f worldAabbMax, int handleMask, int handleSentinel, int maxHandles, btOverlappingPairCache pairCache, boolean disableRaycastAccelerator) {
  ...
  public btAxisSweep3InternalShort(Vector3f worldAabbMin, Vector3f worldAabbMax, int handleMask, int handleSentinel, int maxHandles, btOverlappingPairCache pairCache) {
  ...
  public btAxisSweep3InternalShort(Vector3f worldAabbMin, Vector3f worldAabbMax, int handleMask, int handleSentinel, int maxHandles) {
  ...
  public btAxisSweep3InternalShort(Vector3f worldAabbMin, Vector3f worldAabbMax, int handleMask, int handleSentinel) {
  ...
  public int addHandle(Vector3f aabbMin, Vector3f aabbMax, long pOwner, short collisionFilterGroup, short collisionFilterMask, btDispatcher dispatcher, long multiSapProxy) {
  ...
  public void updateHandle(int handle, Vector3f aabbMin, Vector3f aabbMax, btDispatcher dispatcher) {
